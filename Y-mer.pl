...
# tee_nimekiri_v7.pl    #FINDS INTERSEQTION BETWEEN MODEL AND DEPTH K-MERS AND EXCLUDES THEM
# jaotus.pl             #CALCULATING TRESHOLD FOR SEQUENCING ERRORS AND MEDIAN COVERAGE
# MWS.R                 #MANN-WHITNEY TEST
# MODEL.R               #MODEL CREATOR
# Y_NIPT_nimekiri.txt   #SINGLE COPY K-MERS IN CHRY (GRCH38), https://doi.org/10.5281/zenodo.15089783
